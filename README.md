...
**Живое демо:** документация с кнопкой «Try it out» — <https://damp-violet-4757.mkeyboard138.workers.dev/docs/>, API — `https://damp-violet-4757.mkeyboard138.workers.dev/api/v1` и `/api/v2`, вход `demo@example.com` / `password`. Демо развёрнуто на виртуальном хостинге без Docker, см. [Установка на виртуальный хостинг](#установка-на-виртуальный-хостинг-beget-и-аналоги). Демо-данные общие для всех посетителей.
